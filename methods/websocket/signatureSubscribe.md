...
WebSocket-only. Subscribe to the status of a transaction signature. The request returns a numeric subscription id. Agave then sends `signatureNotification` notifications on the same connection.
